...
one_attempt_arrhythmic_files <- list.files('../data/exp2/final_results_from_sonscience_project/one_attempt_arrhythmic', pattern = 'complete=true', full.names = TRUE)

one_attempt_rhythmic_files <- list.files('../data/exp2/final_results_from_sonscience_project/one_attempt_rhythmic', pattern = 'complete=true', full.names = TRUE)


multi_attempt_arrhythmic_files <- list.files('../data/exp2/final_results_from_sonscience_project/multi_attempt_arrhythmic', pattern = 'complete=true', full.names = TRUE)


multi_attempt_rhythmic_files <- list.files('../data/exp2/final_results_from_sonscience_project/multi_attempt_rhythmic', pattern = 'complete=true', full.names = TRUE)
...
exp2_dem_1 <- read_excel('../data/exp2/final_results_from_sonscience_project/aux/20220531_Survey_1-4.xlsx', sheet = 1)
exp2_dem_2 <- read_excel('../data/exp2/final_results_from_sonscience_project/aux/20220531_Survey_1-4.xlsx', sheet = 2) %>% 
  rename(`Age Range` = `Range Age`)
exp2_dem_3 <- read_excel('../data/exp2/final_results_from_sonscience_project/aux/20220531_Survey_1-4.xlsx', sheet = 3) %>% 
  rename(`Age Range` = `Range Age`)
exp2_dem_4 <- read_excel('../data/exp2/final_results_from_sonscience_project/aux/20220531_Survey_1-4.xlsx', sheet = 4)

exp2_demographics <- rbind(exp2_dem_1, exp2_dem_2, exp2_dem_3, exp2_dem_4) %>% 
  mutate(Gender = case_when(GenderId == 1 ~ "Male", TRUE ~ "Female")) %>% 
  unique()

exp2_demographic_summary <- exp2_demographics %>% 
  count(Gender)

exp2_PercentFemale <- exp2_demographic_summary %>% 
  filter(Gender == "Female") %>% 
  pull(n) / (exp2_demographic_summary %>% filter(Gender == "Female") %>% pull(n) + exp2_demographic_summary %>% filter(Gender == "Male") %>% 
   pull(n))
  

exp2_age_summary <- exp2_demographics %>% 
  dplyr::select(Age) %>% 
  summarise(
        SD = sd(Age),
...
exp2_demographic_summary_country <- exp2_demographics %>% 
  count(CountryCode) %>% 
...
save(long_note_dat, file = '../data/exp2/output_data/long_note_dat.rda')

```

```{r}

load(file = '../data/exp2/output_data/long_note_dat.rda')
...
910 participants aged `r exp2_age_summary$Min.`-`r exp2_age_summary$Max.` (*M* = `r exp2_age_summary$Mean`, *SD* = `r exp2_age_summary$SD`; `r round(exp2_PercentFemale*100, 2)`% female were recruited through the *SliceThePie* marketing panel, across four testing conditions (*N* = `r nrow(exp2_dem_1)`; *N* = `r nrow(exp2_dem_2)`; *N* = `r nrow(exp2_dem_3)`; *N* = `r nrow(exp2_dem_4)`). 67% were from the US, 25% UK, 5% Canada, and the remaining other countries. 8 participants' demographic data was missing (reason unknown).
...
load(file = '../data/exp2/output_data/one_attempt_arrhythmic.rda')

load(file = '../data/exp2/output_data/one_attempt_rhythmic.rda')

load(file = '../data/exp2/output_data/multi_attempt_arrhythmic.rda')

load(file = '../data/exp2/output_data/multi_attempt_rhythmic.rda')
...
save(dat, file = '../data/exp2/output_data/dat.rda')
...
load(file = '../data/exp2/output_data/dat.rda')
...
dat <- dat %>%
  rowwise() %>% 
  mutate(pyin = list(pyin::pyin(paste0('../data/exp2/final_results_from_sonscience_project/sonscience_melodic_recall_audio/', audio_file)))) %>% 
  ungroup()


save(dat, file = '../data/exp2/output_data/dat3.rda')
...
load(file = '../data/exp2/output_data/dat3.rda')
...
save(dat, file = '../data/exp2/output_data/dat4.rda')

```

```{r}

load(file = '../data/exp2/output_data/dat4.rda')
...
save(dat, file = '../data/exp2/output_data/dat5.rda')
...
load(file = '../data/exp2/output_data/dat5.rda')
...
save(dat, file = '../data/exp2/output_data/dat6.rda')
...
load(file = '../data/exp2/output_data/dat6.rda')
...
exp2_tab1 <- tibble(Measure = character(), Description = character())

ft <- qflextable(exp2_tab1)
...
long_note_dat <- long_note_dat %>% 
  ...
  mutate(
    ...
    local_file = paste0("../data/exp2/final_results_from_sonscience_project/sonscience_melodic_recall_audio_long_note/", file)
  ) 
...
save(long_note_dat, file = '../data/exp2/output_data/long_note_dat2.rda')
...
load(file = '../data/exp2/output_data/long_note_dat2.rda')
...
save(long_note_dat_nas_removed, file = '../data/exp2/output_data/long_note_dat_nas_removed.rda')
...
load(file = '../data/exp2/output_data/long_note_dat_nas_removed.rda')
...
save(long_note_agg, file = '../data/exp2/output_data/long_note_agg.rda')

```

```{r}

save(long_note_pca2, file = '../data/exp2/output_data/long_note_pca.rda')
...
save(singing_scores, file = '../data/exp2/output_data/singing_scores.rda')
...
load(file = '../data/exp2/output_data/singing_scores.rda')
...
save(melody_pca2, file = '../data/exp2/output_data/melody_pca2.rda')

melody_pca2_data <- dvs_summarised %>% 
  dplyr::select(note_precision, interval_precision, melody_interval_accuracy)


save(melody_pca2_data, file = '../data/exp2/output_data/melody_pca2_data.rda')
...
save(lm2.2, file = '../data/exp2/output_data/Berkowitz_arrhythmic_mixed_effects_model.rda')
...
save(lm2.2_scaled, file = '../data/exp2/output_data/Berkowitz_arrhythmic_mixed_effects_model_scaled.rda')
...
save(lm_arrhythmic_length_only, file = '../data/exp2/output_data/lm_arrhythmic_length_only.rda')
...
save(lm3.2, file = '../data/exp2/output_data/Berkowitz_rhythmic_mixed_effects_model.rda')
...
exp2_dem_small <- exp2_demographics %>% 
  dplyr::select(UserId, Age, Gender) %>% 
  rename(p_id = UserId) %>% 
  unique()

dat <- dat %>% left_join(exp2_dem_small, by = "p_id")
